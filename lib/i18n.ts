...
export const translations = {
  en: {
    ...
    login: {
      ...
      authDescription: "Your data is protected with industry-standard encryption and security practices.",
    ...
    componentAPI: {
      ...
      noParameters: "No parameters added yet. Click 'Add Parameter' to get started.",
      generatedCode: "Generated Dart Code",
    },
    // Behavior Step
    behavior: {
  ...
  es: {
    ...
    login: {
      ...
      authDescription: "Tus datos están protegidos con cifrado y prácticas de seguridad estándar de la industria.",
    ...
    componentAPI: {
      ...
      noParameters: "No se han agregado parámetros aún. Haz clic en 'Agregar Parámetro' para comenzar.",
      generatedCode: "Código Dart Generado",
    },
    // Behavior Step
    behavior: {
