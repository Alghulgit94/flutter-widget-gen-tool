...
export const translations = {
  en: {
    ...
    docs: {
      ...
      step2Desc: "Our intuitive 7-step form guides you through documenting every aspect of your Flutter component:",
      step2Item1: "Basic Info: Name, type, and description",
      step2Item2: "Variants & States: All possible component variations",
      step2Item3: "Design Specs: Colors, typography, and dimensions",
      step2Item4: "Component API: Props and parameters in Dart syntax",
      step2Item5: "Behavior: Interactions and responsive behavior",
      step2Item6: "Implementation: File location and state management",
      step2Item7: "Review: Validate and export your specification",
  ...
  es: {
    ...
    docs: {
      ...
      step2Desc: "Nuestro intuitivo formulario de 7 pasos te guía a través de documentar cada aspecto de tu componente Flutter:",
      step2Item1: "Información Básica: Nombre, tipo y descripción",
      step2Item2: "Variantes y Estados: Todas las variaciones posibles del componente",
      step2Item3: "Especificaciones de Diseño: Colores, tipografía y dimensiones",
      step2Item4: "API del Componente: Props y parámetros en sintaxis Dart",
      step2Item5: "Comportamiento: Interacciones y comportamiento responsivo",
      step2Item6: "Implementación: Ubicación del archivo y manejo de estado",
      step2Item7: "Revisar: Valida y exporta tu especificación",
